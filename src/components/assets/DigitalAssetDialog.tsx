...
export default function DigitalAssetDialog({
  ...
  return (
    ...
    <div className={`fixed inset-0 bg-black/60 backdrop-blur-sm z-[60] p-0 sm:p-4 transition-opacity duration-200 ${
      ...
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full sm:max-w-4xl sm:w-[calc(100%-2rem)] max-h-[100dvh] sm:max-h-[90vh] sm:rounded-3xl rounded-none border border-white/10 bg-slate-900 flex flex-col shadow-2xl"
...
function AssetManageDialog({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[65] p-0 sm:p-4" onClick={onClose}>
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full sm:max-w-lg sm:w-[calc(100%-2rem)] max-h-[100dvh] sm:max-h-[85vh] sm:rounded-3xl rounded-none border border-white/10 bg-slate-900 flex flex-col shadow-2xl"
        onClick={e => e.stopPropagation()}
      >
        {/* Header */}
